...
class UNetMidBlock3DCrossAttn(nn.Module):
    ...
    def forward(
        ...
        if self.training and self.gradient_checkpointing:
            ...
            hidden_states = torch.utils.checkpoint.checkpoint(create_custom_forward(self.resnets[0]), hidden_states, temb, **ckpt_kwargs)
            hidden_states = torch.utils.checkpoint.checkpoint(create_custom_forward(self.temp_convs[0]), hidden_states, num_frames, **ckpt_kwargs)
        else:        
